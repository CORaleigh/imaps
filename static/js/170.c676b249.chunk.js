...
`}static get is(){return"vaadin-grid-sort-column"}static get properties(){return{path:String,direction:{type:String,notify:!0}}}_prepareHeaderTemplate(){const e=this._prepareTemplatizer(this.$.headerTemplate);return e.templatizer.dataHost=this,e}_getHeader(e,t){return e||this._generateHeader(t)}}customElements.define(g.is,g);i(1080);var v=i(25);const E=e=>{const[t,i]=Object(r.useState)(!1),[a,l]=Object(r.useState)(!1),[c,d]=Object(r.useState)(0),[u,m]=Object(r.useState)([]),h=Object(r.useRef)(),p=Object(r.useRef)(),f=Object(r.useRef)(null);return Object(r.useEffect)((()=>{l(e.loading)}),[e.loading]),Object(r.useEffect)((()=>{p.current&&(p.current.render(),p.current.recalculateColumnWidths(),p.current.notifyResize())}),[e.selectedTab]),Object(r.useEffect)((()=>{var r;t||e.layer&&((e=>n.c((t=>{e.load().then((()=>{e.popupTemplate.fieldInfos.forEach((e=>{["SITE_ADDRESS","OWNER","PIN_NUM","PIN_EXT","REID"].includes(e.fieldName)?e.visible=!0:e.visible=!1})),customElements.whenDefined("vaadin-grid").then((()=>{t(A(e))}))}))})))(e.layer).then((e=>{m([...e]),((e,t,i)=>{const r=e.querySelectorAll("vaadin-grid-sort-column");o(t,i,r),r.forEach((e=>{e.renderer=(e,i,r)=>{const n=t.fields.find((e=>e.alias===i.header));e.firstElementChild||(e.innerHTML='<div style="white-space: normal"></div>'),n&&(e.firstElementChild.textContent=r.item.attributes[n.name],n.name.includes("DATE")&&r.item.attributes[n.name]&&(e.firstElementChild.textContent=new Date(r.item.attributes[n.name]).toLocaleDateString()),(n.name.includes("VAL")||n.name.includes("PRICE"))&&r.item.attributes[n.name]&&(e.firstElementChild.textContent=`$${r.item.attributes[n.name].toLocaleString("en-US",{maximumFractionDigits:0})}`))}}))})(p.current,h.current,f.current)})),h.current=e.layer,i(!0),null===(r=p.current)||void 0===r||r.addEventListener("active-item-changed",(t=>{const i=t.detail.value;var r,n,a;i&&(null===(r=p.current)||void 0===r||null===(n=r.selectedItems)||void 0===n||n.forEach((e=>{var t;null===(t=p.current)||void 0===t||t.deselectItem(e)})),null===(a=p.current)||void 0===a||a.selectItem(i),e.featureSelected(i))})));return()=>{}}),[e.layer]),Object(r.useEffect)((()=>{h.current&&e.filter&&(l(!0),((e,t,i)=>(s=t,n.c((r=>{e.queryFeatures({where:t,returnGeometry:!0,outFields:["*"]}).then((e=>{i.items=e.features,r(e.features.length)}))}))))(h.current,e.filter,p.current).then((e=>{l(!1),d(e)})))}),[e.filter]),Object(v.jsxs)("div",{className:"panel",children:[Object(v.jsxs)("div",{className:"esri-feature-table__header",children:[Object(v.jsx)("div",{className:"esri-feature-table__loader-container",children:Object(v.jsx)("div",{className:"esri-feature-table__loader "+(a?"loading":"")})}),Object(v.jsxs)("div",{className:"esri-feature-table__title",children:["Features: ",c]}),Object(v.jsx)("div",{className:"esri-feature-table__menu",children:Object(v.jsx)("div",{"data-node-ref":"_rootNode",className:"esri-button-menu esri-widget",children:Object(v.jsx)("button",{"aria-pressed":"false","aria-controls":"1783678efcd-widget-1-menu","aria-haspopup":"true","aria-label":"Options",className:"esri-button-menu__button ",ref:f,title:"Options",type:"button"})})})]}),Object(v.jsx)("vaadin-grid",{"aria-label":"Sorting Example",theme:"compact dark",className:"esri-widget esri-grid",ref:p,children:u.map((e=>Object(v.jsx)("vaadin-grid-sort-column",{header:e.header,path:e.path,id:e.key,width:e.width,hidden:e.hidden?"":null,name:e.name},e.key)))})]})};t.default=E}}]);
//# sourceMappingURL=170.c676b249.chunk.js.map